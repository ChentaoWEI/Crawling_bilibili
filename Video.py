...
class Bili_Video_Download():
    ...
    def main(self):
        ...
        option.add_argument("--user-data-dir=" + r"C:/Users/wdsg/AppData/Local/Google/Chrome/User Data/")  # 启用带插件的浏览器
    ...
    def Download_video(self):
        try:
            # 点击哔哩哔哩助手
            sleep(2)
            self.bro.find_element_by_id('bilibiliHelper2HandleButtonWrapper').click()
        ...
        try:
            # 点击下载格式
            sleep(2)
            self.bro.find_element_by_xpath('//button[@class="sc-kEjbxe grJwlU button-view"]/span[text()=\"360P 流畅\"]').click()
            sleep(2)
        except Exception as e:
        ...
        try:
            # 点击“点击下载按钮”
            sleep(2)
            self.bro.find_element_by_xpath('//a[@class="download-link"]').click()
            sleep(2)
        except Exception as e:
            print("点击下载按钮出现异常：", end="\n")
            print(e)
            pass

if __name__ == "__main__":
    Spider=Bili_Video_Download()
    Spider.main()